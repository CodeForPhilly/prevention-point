# Generated by Django 2.2.2 on 2019-10-18 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('urgency', models.CharField(choices=[('ONE', 1), ('TWO', 2), ('THREE', 3), ('FOUR', 4), ('FIVE', 5)], max_length=20)),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Participant')),
                ('program_service_map', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.ProgramServiceMap')),
            ],
        ),
        migrations.CreateModel(
